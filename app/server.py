...
export_file_url = 'https://drive.google.com/uc?export=download&id=1BVgmbtWDiXMA_edpA8XSZyQ9t2qTO-N1'
export_file_name = 'dn121.pkl'
...
async def check(request):
    ...
    text = str(prediction) + str(top_probs.item())
    return JSONResponse({'result': text})
    # if top_probs.item() < 0.90:
    #     return JSONResponse({'result': 'Seems like the image provided is not a mineral'})
    # else:
    #     return JSONResponse({'result': str(prediction)})
